...
- Меняет расположение иконок и надписей
- Запуск:
...
- **Команды swaybg / swww не найдены**  
  → Установите их:

```bash
sudo pacman -S swaybg swww
```
...
Пулл-реквесты и улучшения приветствуются!
